...
export class Source {
  ...
  private validate(): void {
    ...
    if (!this.props.workspaceId) throw new ValidationError("WORKSPACE_ID_REQUIRED");
    if (!this.props.missionId) throw new ValidationError("MISSION_ID_REQUIRED");
    if (!this.props.title?.trim()) throw new ValidationError("SOURCE_TITLE_REQUIRED");
  }
  ...
  get sourceQuality() { return this.props.sourceQuality; }
  get content() { return this.props.content; }
  get metadata() { return { ...this.props.metadata }; }
  get createdAt() { return this.props.createdAt; }

  public toProps(): SourceProps { return { ...this.props }; }
}
