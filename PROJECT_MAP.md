# 🗺️ PROJECT MAP — epios
> Автоматически сгенерировано: `2026-05-14 00:08:12`
...
| **Total Lines** | `11091` | Суммарно по проекту |
| **Project Weight** | `~90 412 tokens` | Оценка (4 символа/токен) |
...
| `demo-shell/src/components/GraphCanvas.tsx` | 580 | 16.2 KB | — |
