# 🗺️ PROJECT MAP — epios
> Автоматически сгенерировано: `2026-05-14 00:15:13`
...
| **Total Lines** | `11093` | Суммарно по проекту |
| **Project Weight** | `~90 436 tokens` | Оценка (4 символа/токен) |
...
| `demo-shell/src/components/GraphCanvas.tsx` | 582 | 16.3 KB | — |
