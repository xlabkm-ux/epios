...
- [ ] **MCP Plugin Orchestration:** Управление связями шаблонов и MCP-плагинов передается в профильный процесс (см. `docs/09_ai_and_mcp_integration_roadmap/01_AI_MCP_ROADMAP.md`).
